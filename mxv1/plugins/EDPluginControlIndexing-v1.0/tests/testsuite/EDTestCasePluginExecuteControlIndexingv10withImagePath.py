...
class EDTestCasePluginExecuteControlIndexingv10withImagePath(EDTestCasePluginExecuteControlIndexingv10):
    ...
    def __init__(self, _edStringTestName=None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), "XSDataIndexingInput_withImagePath.xml"))
        self.strReferenceDataOutputFile = os.path.join(self.getPluginTestsDataHome(), "XSDataIndexingResult_withImagePath.xml")
