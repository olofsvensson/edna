...
class EDTestCasePluginExecuteExecHelicalPositionsv1_0_useCase3(EDTestCasePluginExecute):
    """
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputHelicalPositions_useCase3.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultCalculateHelicalPositions_useCase3.xml"))
