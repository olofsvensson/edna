...
class EDTestCasePluginExecuteExecHelicalPositionsv1_0_useCase2(EDTestCasePluginExecute):
    """
    ...
    def __init__(self, _strTestName = None):
        ...
        self.setDataInputFile(os.path.join(self.getPluginTestsDataHome(), \
                                           "XSDataInputHelicalPositions_useCase2.xml"))
        self.setReferenceDataOutputFile(os.path.join(self.getPluginTestsDataHome(), \
                                                     "XSDataResultCalculateHelicalPositions_useCase2.xml"))
