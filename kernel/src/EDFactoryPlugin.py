...
class EDFactoryPlugin(EDLogging):
    ...
    def saveModuleDictionaryToDisk(self, _strPath):
        ...
        try:
            ...
            self.warning("The module cache could not be written to disk: %r", e)
    ...
    def __searchRootDirectories(self):
        ...
        for strPluginRootDirectory in self.__listPluginRootDirectory:
            for (strPath, listDirs, listFiles) in os.walk(strPluginRootDirectory):
                self.__addPluginLocation(strPath, strPath, listFiles)
